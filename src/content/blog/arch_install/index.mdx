...
|grub efibootmgr os-prober|(可更换) 引导工具,本教程使用grub, 也可以使用 systemd-boot 或 limine||
...
安装插件 `background`, `Chinese (Simplified) (简体中文) Language Pack for Visual Studio Code`, `Path Intellisense`, `Panda Theme`
...
vscode server 安装插件 `LaTeX`, `LaTeX Workshop`
